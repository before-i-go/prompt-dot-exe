...
impl ZstdCompressor {
    ...
    pub fn decompress_to_string(&self, data: &[u8]) -> CompressionResult<String> {
        ...
        String::from_utf8(decompressed)
            .map_err(|e| CompressionError::zstd_compression(std::io::Error::new(
...
mod tests {
    ...
    fn test_zstd_compression_levels() {
        let test_data = "This is a test string that should compress well with repetitive patterns. ".repeat(100);
